  ...
  categories: [
    {
      ...
      cards: [
        ...
        {
          id: 'A3',
          q: '你們閉氣實驗的「第一破點 FBP」是受試者自己喊的，這是主觀量測，會不會每個人對「想呼吸」的容忍度不同？',
          analysis: '測試你對「主觀量測」誤差的處理能力，評審想看你是否誠實面對量測的限制。',
          keypoints: [
            'FBP 確實是主觀量測——受試者自報「強烈想呼吸」的時間，每個人對「想呼吸」的容忍度不一樣。',
            '我們的對策：每個受試者「自己跟自己比」（ABA 設計），不跨人比較絕對值。',
            '實驗前讓每位受試者先做 1 次「練習測量」，熟悉「想呼吸」的感覺，再做正式測量。',
            '我們關心的是「FBP 縮短量／百分比」這個相對指標，所以個體絕對值差異可被內部對照抵消。',
            '這個方法跟國際自由潛水研究（Lindholm 2009、Schagatay 2023）使用的 FBP 方法一致。',
            '進階做法：可加裝「橫膈膜肌電圖」客觀量測呼吸衝動，但我們的器材有限。'
          ],
          bonus: '可以說：「主觀量測在運動生理研究中很常見，重點是『內部一致性』而非『絕對精確度』。」這個觀念會讓評審眼睛一亮。'
        },
        {
          id: 'A4',
