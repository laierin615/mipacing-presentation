...
臺東縣 Salimpo 阿美山海文化實驗小學 114 學年度科展網頁簡報。雙模式（🎤 簡報 / 🧒 自學），14 章內容含 5 個互動模擬器、潮汐動畫、問答準備區、20 題小測驗、20 個科學名詞辭典。
...
| 5 | exp2 | 魚槍的祕密 | ⭐ | 浮沉子互動 |
| 6 | exp3 | 水裡的眼睛 | ⭐ | 折射滑桿+9 種魚種辨識+鸚哥魚 3 影片+河豚 FDA PDF |
| 7 | exp4 | 連續失手兩次就上岸 | ⭐ | CO₂ 計時器 |
| 8 | exp5 | 5 種漁法大比較 | ⭐ | 雷達圖 |
| 9 | tek | 耆老的話 = 科學的話 | ⭐ | 6 條對話對照 |
| 10 | glossary | 阿美語小辭典 |  | 30 詞 + 20 個科學名詞 + 鸚哥魚 3 影片 |
| 11 | quiz | 小測驗 |  | 20 題 |
| 12 | qa | 問答準備區 | ⭐ priorityNav | 初賽實際提問 11 張卡 + 決賽模擬追問 10 張卡，5 類，側邊索引置頂 |
